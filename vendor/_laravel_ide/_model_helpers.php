...
namespace App\Models {
   ...
   * @property string|null $sunarp_cargo_representante
   * @property string|null $sunarp_nombre_representante
   * @property string|null $sunarp_dni_representante
   * @property string|null $sunarp_partida
   * @property string|null $sunarp_oficina
   * @property string|null $regimen_l_desde
   ...
   * @property string|null $cliente_secret
   * @property string|null $cliente_id
   * @property string|null $clave_sol
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereUsuarioSol($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereClaveSol($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereClienteId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereClienteSecret($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereToken($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereExpiracion($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereUsuarioAfp($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereClaveAfp($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereImagen($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereEstado($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereRegimenTributario($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereRegimenTDesde($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereRegimenLaboral($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereRegimenLDesde($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereSunarpOficina($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereSunarpPartida($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereSunarpDniRepresentante($value)
   * @method static \Illuminate\Database\Eloquent\Builder<Empresa>|Empresa whereSunarpNombreRepresentante($value)
   ...
   * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereIdEmpresa($value)
  ...
  /**
   * App\Models\UserCompanie
   *
   * @property \Illuminate\Support\Carbon|null $updated_at
   * @property \Illuminate\Support\Carbon|null $created_at
   * @property mixed $empresa_id
   * @property mixed $user_id
   * @method static \Illuminate\Database\Eloquent\Builder<UserCompanie>|UserCompanie whereUserId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<UserCompanie>|UserCompanie whereEmpresaId($value)
   * @method static \Illuminate\Database\Eloquent\Builder<UserCompanie>|UserCompanie whereCreatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder<UserCompanie>|UserCompanie whereUpdatedAt($value)
   * @method static \Illuminate\Database\Eloquent\Builder<UserCompanie>|UserCompanie newModelQuery()
   * @method static \Illuminate\Database\Eloquent\Builder<UserCompanie>|UserCompanie newQuery()
   * @method static \Illuminate\Database\Eloquent\Builder<UserCompanie>|UserCompanie query()
   * @method static mixed select($columns)
   * @method static mixed selectSub($query, $as)
   * @method static mixed selectRaw($expression, array $bindings)
   * @method static mixed fromSub($query, $as)
   ...
   * @mixin \Illuminate\Database\Query\Builder
   */
  class UserCompanie extends \Illuminate\Database\Eloquent\Model
  {
    //
  }
